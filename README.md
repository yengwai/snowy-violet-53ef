...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/snowy-violet-53ef
```

A live public deployment of this template is available at [https://snowy-violet-53ef.templates.workers.dev](https://snowy-violet-53ef.templates.workers.dev)
